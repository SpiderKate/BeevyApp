...
#cursor.execute("CREATE table rooms (id INTEGER PRIMARY KEY AUTOINCREMENT, room_ID INT NOT NULL, name TEXT NOT NULL, password TEXT, is_public BOOLEAN NOT NULL, user_id INT NOT NULL, is_active BOOLEAN DEFAULT 1, FOREIGN KEY(user_id) REFERENCES users(id));")
